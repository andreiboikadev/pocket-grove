...
This is the source-of-truth map for Pocket Grove. **No new doc should exist unless it is linked here.**
...
This project is a ~1-day MVP; the doc set is kept lean on purpose. Create these **when friction
...
- `quality/test-strategy.md`, `quality/performance-budget.md` — performance budget is summarized in
  the guardrails; promote to its own file once profiling on device starts.
